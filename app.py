...
@media (max-width: 768px) {
    ...
    .metric-value { font-size: 1.4em !important; }
    .metric-label { font-size: 0.65em !important; }
    .phish-card { padding: 14px !important; margin-bottom: 10px !important; }
    [data-testid="stDataFrame"] { overflow-x: auto !important; max-width: 100vw !important; }
    .stButton > button { width: 100% !important; padding: 10px 12px !important; font-size: 0.9em !important; }
    .stTextInput > div > div > input { font-size: 16px !important; }
    .stTextArea > div > div > textarea { font-size: 16px !important; }
    h2 { font-size: 1.3em !important; }
    h3 { font-size: 1.1em !important; }
    .login-container { margin: 20px auto !important; padding: 24px 16px !important; }
}
...
def show_auth_page():
    ...
    with col2:
        ...
        <div style='text-align:center; padding: 40px 0 20px;'>
            ...
            <h1 class='glow-text' style='color: #00d4aa; font-size: 2.5em; margin: 0;'>PhishGuard AI</h1>
        ...
        with tab_login:
            ...
            <p style='text-align:center; color: #3a5a7a; font-size: 0.85em; margin-top: 20px;'>
                Default admin: <code style='color:#00d4aa'>admin</code> /
                <code style='color:#00d4aa'>admin123</code>
            </p>
            """, unsafe_allow_html=True)
...
def show_main_app():
    ...
    with st.sidebar:
        ...
        <div style='text-align:center; padding: 20px 0;'>
            ...
            <div style='color: #00d4aa; font-size: 1.4em; font-weight: 800;'>PhishGuard</div>
        ...
        <div style='background: rgba(0,0,0,0.3); border-radius: 10px; padding: 12px; margin: 8px 0;'>
            ...
            <div style='color: #00e676; font-size: 0.85em;'>⬤ Active and Ready</div>
